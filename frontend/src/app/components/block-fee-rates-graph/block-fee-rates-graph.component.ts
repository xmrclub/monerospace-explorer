...
export class BlockFeeRatesGraphComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.widget) {
      ...
      this.seoService.setDescription($localize`:@@meta.description.bitcoin.graphs.block-fee-rates:See Monero fee rates visualized over time, including minimum and maximum fee rates per block along with fee rates at various percentiles.`);
