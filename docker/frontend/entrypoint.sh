...
__PROXIED_SERVICES_HOST__=${PROXIED_SERVICES_HOST:=http://${__MEMPOOL_BACKEND_MAINNET_HTTP_HOST__}:${__MEMPOOL_BACKEND_MAINNET_HTTP_PORT__}}
...
__SERVICES_API__=${SERVICES_API:=/api/v1/services}
